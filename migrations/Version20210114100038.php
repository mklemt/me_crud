 ...
 */
final class Version20210114100038 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO product_event (eventId, productStatus_status, eventTime_dateTime, productId) SELECT eventId, productStatus_status, eventTime_dateTime, productId FROM __temp__product_event');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__product_event AS SELECT eventId, productStatus_status, eventTime_dateTime, productId FROM product_event');
        $this->addSql('DROP TABLE product_event');
        $this->addSql('CREATE TABLE product_event (eventId INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, productStatus_status INTEGER NOT NULL, eventTime_dateTime DATETIME NOT NULL, productId VARCHAR(100) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO product_event (eventId, productStatus_status, eventTime_dateTime, productId) SELECT eventId, productStatus_status, eventTime_dateTime, productId FROM __temp__product_event');
        $this->addSql('DROP TABLE __temp__product_event');
        $this->addSql('CREATE INDEX IDX_9AF271FB36799605 ON product_event (productId)');
    }
